...
const TABS = [
    ...
    { icon: Building2, name: "New Launch" },
    { icon: Landmark, name: "Commercial" },
    { icon: Map, name: "Plots" },
];
...
const TAB_CONFIG = {
    ...
    Plots: {
        stats: "3K+ Plots",
        placeholders: [
            "Find plots near highways",
            "Explore gated farmland plots",
            "Search investment lands",
        ],
        trending: ["Farm House", "Highway Plot", "Corner Plot", "Investment Land"],
    },
};
