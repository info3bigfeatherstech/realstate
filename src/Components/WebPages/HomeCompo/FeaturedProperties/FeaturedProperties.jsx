        ...
        <section className="bg-white py-20 font-['satoshi']">
            <div className="w-full px-5 md:px-10 lg:px-16">
                ...
                <div className="mb-12 flex flex-wrap items-end justify-between gap-6">
                    <h3 className="max-w-[800px] text-[clamp(28px,4vw,42px)] font-uppercase leading-[1.05] tracking-[-1.5px] text-[#111] sm:text-[36px] lg:text-[35px]">
                ...
                {isLoadingData ? (
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 [&>*]:max-w-[340px] [&>*]:w-full [&>*]:mx-auto xl:[&>*]:max-w-full">
...
// down code is working but structure is slider upper have some changes
// // src/Components/UserSide/FeaturedProperties/FeaturedProperties.jsx
// import React, { useState } from "react";
// import { useNavigate } from "react-router-dom";
