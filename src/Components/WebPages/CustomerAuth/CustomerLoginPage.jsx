        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-10 sm:py-14">
          <div className="w-full max-w-md">
            ...
            <GoogleAuthButton
              ...
              disabled={isLoading}
              text="continue_with"
              onPendingChange={setIsGoogleFlowPending} // NEW: hide email login form while Google's profile-type card is open
            />

            {/* NEW: divider + email login form hidden while Google's own profile-type picker is showing, so the user only sees one flow at a time */}
            {!isGoogleFlowPending && (
              <>
