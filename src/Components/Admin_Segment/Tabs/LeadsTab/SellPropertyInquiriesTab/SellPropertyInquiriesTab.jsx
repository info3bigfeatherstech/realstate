...
} from "../../../Admin_Redux/SellPropertyInquiryApi/sellPropertyInquiryApi";
import {
    setPage,
    setLimit,
    setSearch,
...
import { downloadSellPropertyTemplate } from "./downloadSellPropertyTemplate";
...
const SellPropertyInquiriesTab = () => {
    const dispatch = useDispatch();
    const filters = useSelector((state) => state.sellPropertyInquiry);
    const { data: constants } = useGetConstantsQuery();
    const { data: stats, isLoading: statsLoading } = useGetSellPropertyInquiryStatsQuery();
    const { data, isLoading, isFetching } = useGetSellPropertyInquiriesQuery(filters);
    ...
    const handleDownloadTemplate = async () => {
        ...
        try {
            await downloadSellPropertyTemplate();
            toast.success("Sell Property form template downloaded");
        } catch (err) {
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h3 className="text-lg font-semibold text-slate-800">Sell Property Inquiries</h3>
            ...
            <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
                {isLoading ? (
                    ...
                    <p className="text-center text-slate-400 py-16 text-sm">No sell property inquiries found</p>
                ) : (
                            ...
                            <tbody>
                                {inquiries.map((inq) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 text-slate-600">Sell Property</td>
...
export default SellPropertyInquiriesTab;