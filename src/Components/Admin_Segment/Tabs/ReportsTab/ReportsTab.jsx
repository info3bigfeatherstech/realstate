// src/tabs/ReportsTab/ReportsTab.jsx
import React, { Suspense } from "react";
import { useSearchParams } from "react-router-dom";
import { REPORTS_REGISTRY } from "./ReportsRegistry";

const ReportsTab = () => {
  const [searchParams, setSearchParams] = useSearchParams();

  const activeSubTab = searchParams.get("ctab") || "propertyperformance";
  ...
  const activeConfig = REPORTS_REGISTRY.find((sub) => sub.id === activeSubTab) || REPORTS_REGISTRY[0];
