// src/tabs/DocumentsTab/ApprovalDocumentsTab/ApprovalDocumentsTab.jsx
...
const MOCK_DOCS = [
  {
    id: "ADOC0001",
    documentName: "RERA Registration - 2BHK Sea View Apartment",
  ...
  {
    id: "ADOC0002",
    documentName: "Occupancy Certificate (OC) - Commercial Office, Andheri",
  ...
  {
    id: "ADOC0004",
    documentName: "RERA Registration - 1BHK Studio, Koramangala",
  ...
  return (
    <div className="p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h3 className="text-lg font-semibold text-slate-800">Approval Documents</h3>
          <p className="text-sm text-slate-500 mt-1">RERA, Occupancy and Completion Certificates</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by property, document..."
            ...
            {docs.map((doc) => (
              <tr key={doc.id} className="border-b border-slate-50 hover:bg-slate-50/60 transition-colors">
                <td className="py-4 pr-4">
                  <div className="font-medium text-slate-800 max-w-sm">{doc.documentName}</div>
...
export default ApprovalDocumentsTab;