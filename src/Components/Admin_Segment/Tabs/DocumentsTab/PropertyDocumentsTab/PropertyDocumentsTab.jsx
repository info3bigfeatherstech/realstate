// src/tabs/DocumentsTab/PropertyDocumentsTab/PropertyDocumentsTab.jsx
...
const MOCK_DOCS = [
  {
    id: "PDOC0001",
    documentName: "Sale Deed - 2BHK Sea View Apartment",
    uploadedBy: "Rajesh Sharma",
    uploadedDate: "05 Jun 2026",
    status: "Verified",
    expiryDate: "—",
  },
  {
    id: "PDOC0002",
    documentName: "Property Registry - Commercial Office, Andheri",
    uploadedBy: "Priya Patel",
    uploadedDate: "06 Jun 2026",
    status: "Pending",
    expiryDate: "—",
  },
  {
  ...
  {
    id: "PDOC0004",
    documentName: "Encumbrance Certificate - 1BHK Studio, Koramangala",
  ...
  return (
    <div className="p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h3 className="text-lg font-semibold text-slate-800">Property Documents</h3>
          <p className="text-sm text-slate-500 mt-1">Sale deeds, registry papers and ownership documents</p>
        </div>
